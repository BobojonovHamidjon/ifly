...
>
  ...
  <div className='grid gap-4 grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
    <div className='bg-gray-800 text-white p-6 rounded-xl shadow-lg border w-full'>
      <h3 className="text-xl font-semibold mb-4">{t('malumot.plaj')}</h3>
      <p className="text-zinc-400">{t('malumot.title')}</p>
    </div>
    <div className='bg-gray-800 dark:text-white p-6 rounded-xl shadow-lg border w-full backdrop-blur-xl'>
      <h3 className="text-xl font-semibold mb-4">{t("malumot.tog'")}</h3>
      <p className="text-zinc-400 ">{t('malumot.chiqish')} </p>
    </div>
    <div className='bg-gray-800 dark:text-white p-6 rounded-xl shadow-lg border w-full backdrop-blur-xl'>
